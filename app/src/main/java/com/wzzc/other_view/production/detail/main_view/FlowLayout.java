package com.wzzc.other_view.production.detail.main_view;
...
import com.wzzc.other_view.production.detail.main_view.main_view.logic.CommonLogic;
import com.wzzc.other_view.production.detail.main_view.main_view.logic.ConfigDefinition;
import com.wzzc.other_view.production.detail.main_view.main_view.logic.LineDefinition;
import com.wzzc.other_view.production.detail.main_view.main_view.logic.ViewDefinition;
...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int value1 = a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, 0);
            setHorizontalSpacing(value1);
            int value2 = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, 0);
            setVerticalSpacing(value2);
        } finally {
            a.recycle();
        }
    }

    protected void setHorizontalSpacing(int value) {
        this.config.setHorizontalSpacing(value);
    }

    protected void setVerticalSpacing(int value) {
        this.config.setVerticalSpacing(value);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        totalControlWidth -= this.config.getHorizontalSpacing();
        totalControlHeight -= this.config.getVerticalSpacing();
