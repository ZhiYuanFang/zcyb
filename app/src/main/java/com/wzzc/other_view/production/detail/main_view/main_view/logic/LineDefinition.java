package com.wzzc.other_view.production.detail.main_view.main_view.logic;
...
public class LineDefinition {
    ...
    public void addView(int i, ViewDefinition child) {
        ...
        this.lineLength = this.lineLength + child.getLength() + child.getSpacingLength() + this.config.getHorizontalSpacing();
        this.lineThickness = Math.max(this.lineThickness, child.getThickness() + child.getSpacingThickness() + this.config.getVerticalSpacing());
    }
