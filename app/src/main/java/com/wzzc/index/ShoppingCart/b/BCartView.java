...
public class BCartView extends BaseView implements BCartDelegate{
    //region ```
    ...
    public BCartView(Context context) {
        super(context);
        init();
    }

    public BCartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    class MyAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = new BCartGoodsItemView(BCartView.this,c);
            }
