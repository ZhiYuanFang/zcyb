...
public class CommonChartView extends View {
    ...
    private int chartLineColor = Color.RED;// 绘制趋势线的颜色
    ...
    private List<List<Float>> x_coord_values;//每个点状态值
    ...
    private void demo() {
        ...
        // TODO 测试
            ...
            for (int j = 0; j < 10; j++) {
//                Random r = new Random();
//                Float z = Float.valueOf(j);
//                pointInList.add(z);
                x_coords.add("12." + (j + 1));
            }
        List<Float> z = new ArrayList<Float>();
//        z.add(Float.valueOf(2));
//        z.add(Float.valueOf(3));
//        z.add(Float.valueOf(4));
//        z.add(Float.valueOf(50));
//        z.add(Float.valueOf(6));
//        z.add(Float.valueOf(7));
//        z.add(Float.valueOf(8));
//        z.add(Float.valueOf(9));
//        z.add(Float.valueOf(10));
//        z.add(Float.valueOf(5));

        pointList=x_coord_values;
...
//            }
    ...
    private void setYTitle(List<Point> listY, Canvas canvas) {
        ...
        if (pointList == null) {
            ...
            maxNumber = maxNumber + maxNumber / 4;
            titleYList = new ArrayList<String>();
...
//            titleYList.add("20K");
        ...
        for (int i = 0; i < numberOfY; i++) {
            ...
            if (i != 0) {
                canvas.drawText(titleYList.get(i), paddingLeft - appendX - paddingLeft / 3, paddingTop + listY.get(i).y, paint);
            } else {
                canvas.drawText(titleYList.get(i) + yUnit, paddingLeft - appendX - paddingLeft /3, paddingTop + listY.get(i).y, paint);
            }
        }
    }
    ...
    private void setXTitle(List<Point> listX, Canvas canvas) {
        ...
        for (int i = 0; i < numberOfX; i++) {
            ...
            canvas.drawText(x_coords.get(i), listX.get(i).x,
                    listX.get(i).y + paddingTop + paddingDown / 2
                    , paint);
            canvas.restore();
        }
    ...
    public void setx_coords(List<String> x_coords) {
     ...
     */
    public void  setValue( List<String> x_coords ,List<List<Float>> x_coord_values) {
