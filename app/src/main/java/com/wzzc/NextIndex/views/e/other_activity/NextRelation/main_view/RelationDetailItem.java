 ...
 * 间推列表item
 */
@ContentView(R.layout.layout_relation_detail_item)
public class RelationDetailItem extends BaseView{
    ...
    public RelationDetailItem(Context context) {
        super(context);
        init();
    }

    public RelationDetailItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
