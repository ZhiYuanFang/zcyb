package com.wzzc.NextIndex.views.e.other_activity.order.waitSendOrder;
...
public class BackOrdersActivity extends BaseActivity {
    ...
    public void GetServerInfo() {
        ...
        try {
            ...
            para.put("type", "await_ship");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        AsynServer.BackObject(BackOrdersActivity.this , "order/list",false,main_view, para, new AsynServer.BackObject() {
            @Override
