package com.wzzc.NextIndex.views.e.other_activity.order.hasFinishOrder;
...
public class CompletedActivity extends BaseActivity {
    ...
    public void GetServerInfo() {
        ...
        try {
            para.put("type", "finished");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        AsynServer.BackObject(CompletedActivity.this , "order/list",false,main_view, para, new AsynServer.BackObject() {
            @Override
