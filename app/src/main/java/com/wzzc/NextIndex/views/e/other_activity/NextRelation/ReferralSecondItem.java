 ...
 */
@ContentView(R.layout.layout_referral_second_item)
public class ReferralSecondItem extends BaseView {
    ...
    public ReferralSecondItem(Context context) {
        super(context);
        init();
    }

    public ReferralSecondItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
