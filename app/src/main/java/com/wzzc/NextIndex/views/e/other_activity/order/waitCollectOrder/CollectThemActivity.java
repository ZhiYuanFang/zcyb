package com.wzzc.NextIndex.views.e.other_activity.order.waitCollectOrder;
 ...
 */
public class CollectThemActivity extends BaseActivity {
    ...
    public void GetServerInfo() {
        ...
        try {
            para.put("type", "shipped");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        AsynServer.BackObject(CollectThemActivity.this , "order/list",false,main_view, para, new AsynServer.BackObject() {
            @Override
